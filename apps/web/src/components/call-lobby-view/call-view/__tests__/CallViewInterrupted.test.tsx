...
describe('CallView Component - Call Interrupted (Awaiting Return) Unit Tests', () => {
  ...
  it('renders interrupted call panel for attendant users', () => {
    ...
    useCurrentUserStore.setState({
      currentUser: { id: 'att-1', name: 'Attendant', email: 'attendant@example.com', role: 'attendant', avatarUrl: '', status: 'in-call' },
    });
  ...
  it('calls handleStartCall when customer clicks "Return"', () => {
    ...
    useCurrentUserStore.setState({
      currentUser: { id: 'cust-1', name: 'Customer', email: 'customer@example.com', role: 'customer', avatarUrl: '', status: 'in-call' },
    });
