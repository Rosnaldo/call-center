...
export type WsEvent = 'online_users_broadcast' | 'heartbeat_ack' | 'user_logouted' | 'user_disconnected' | 'incoming_call_sent' | 'incoming_call_received' | 'incoming_call_cancelled' | 'call_accepted' | 'call_completed' | 'participant_joined' | 'participant_left' | 'meeting_ended' | 'user_tokens_updated' | 'chat_message_received';
